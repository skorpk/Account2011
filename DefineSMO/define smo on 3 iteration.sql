...
declare @idFile INT
select @idFile=id from vw_getIdFileNumber where CodeM='154602' AND ReportYear=2017 AND NumberRegister=200
...
--WHERE e.ErrorNumber=513

--SELECT * FROM @t
--select @@ROWCOUNT
SET STATISTICS TIME ON
SELECT * FROM @t  --WHERE FAM='Петрова'
...
SELECT * FROM #tPeople WHERE rf_idRefCaseIteration=81752906
