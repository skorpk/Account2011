...
WHERE f.DateRegistration>@dtStart AND f.DateRegistration<GETDATE() AND a.ReportYear=@year 
		AND m.MES IN ('2530012','2540012','2550012','2560012','2565012')/*('2004005','2504005','2001005','2002005','2003005')*/
)
SELECT c.rf_idSMO, ISNULL(s.sNameS,'Иногородний') ,l.CodeM,l.NameS, c.Fam+' '+ISNULL(c.Im,'')+' '+ISNULL(c.Ot,'') AS FIO, c.BirthDay,c.DateBegin, c.DateEnd, c.MES
FROM cases c INNER JOIN OMS_NSI.dbo.sprAllErrors e ON
		c.ErrorNumber=e.Code 
			INNER JOIN dbo.vw_sprT001 l ON
		c.CodeM=l.CodeM    
			LEFT JOIN dbo.vw_sprSMO s ON
	c.rf_idSMO=s.smocod      
