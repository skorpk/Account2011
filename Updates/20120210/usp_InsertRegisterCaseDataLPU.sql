...
/****** Object:  StoredProcedure [dbo].[usp_InsertRegisterCaseDataLPU]    Script Date: 02/10/2012 14:51:46 ******/
SET ANSI_NULLS ON
GO
...
declare @t6 as table (IDCASE int,ID_C uniqueidentifier,IDSERV int,ID_U uniqueidentifier,LPU nchar(6),PROFIL smallint,DET tinyint,DATE_IN date,DATE_OUT date,
