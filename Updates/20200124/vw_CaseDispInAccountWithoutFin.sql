...
/****** Object:  View [dbo].[vw_CaseDispInAccountWithoutFin]    Script Date: 24.01.2020 14:45:02 ******/
SET ANSI_NULLS ON
GO
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			r.id=c.rf_idRecordCasePatient
					...
					c.id=d.rf_idCase
					INNER JOIN (VALUES('ÄÂ2','ÄÂ2'),('ÄÂ1','ÄÂ'),('ÄÂ4','ÄÂ'),('ÎÏÂ','ÄÂ'),('ÄC1','ÄC'),('ÄÓ1','ÄC'),('ÄÓ2','ÄC')) v(id,TypeDisp) ON
            d.TypeDisp=v.id
