USE [RegisterCases]
GO
/****** Object:  StoredProcedure [dbo].[usp_InsertRegisterCaseDataLPU]    Script Date: 19.12.2016 8:28:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF OBJECT_ID('usp_InsertRegisterCaseFileF',N'P') IS NOT NULL
	DROP PROCEDURE usp_InsertRegisterCaseFileF
GO
CREATE proc dbo.usp_InsertRegisterCaseFileF
			@doc xml,
			@patient xml,
			@file varbinary(max),
			@countSluch INT=0
...
DROP TABLE #tDS2_N
GO
GRANT EXECUTE ON usp_InsertRegisterCaseFileF TO db_RegisterCase