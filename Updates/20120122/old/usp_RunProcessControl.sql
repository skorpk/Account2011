...
/****** Object:  StoredProcedure [dbo].[usp_RunProcessControl]    Script Date: 01/22/2012 13:36:13 ******/
...
insert @tError
select c1.rf_idCase,710
from (
		  select p.ID_Patient
		  from t_RegisterPatient p inner join @CaseDefined  c1 on
				p.id=c1.ID_Patient
						left join @tError e on
						c1.rf_idCase=e.rf_idCase
		  where e.rf_idCase is null
