USE AccountOMS
GO
declare @account varchar(15)='34007-10-0S',
		@codeMO char(6)='151005',
		@month TINYINT=11,
		@year SMALLINT=2018
...
if OBJECT_ID('tempDB..#CONS_RC',N'U') is not NULL
	DROP TABLE #CONS_RC
if OBJECT_ID('tempDB..#LEK_PR_RC',N'U') is not NULL
	DROP TABLE #LEK_PR_RC
if OBJECT_ID('tempDB..#SL_K_RC',N'U') is not NULL
	DROP TABLE #SL_K_RC
GO