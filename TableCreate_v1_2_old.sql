...
go
--ALTER TABLE dbo.t_File DROP CONSTRAINT DF_UserName
--go
--ALTER TABLE dbo.t_File DROP COLUMN UserName
--go
...
(
	...
	CONSTRAINT FK_Patient_RecordCase FOREIGN KEY(rf_idRecordCase) REFERENCES dbo.t_RecordCase(id)
)
go
...
(
	ref_idPatient int not null,
	rf_idSMO char(5) null,
	OGRN char(15) null,
	OKATO char(5) null,
	Name nvarchar(100) null,
	CONSTRAINT FK_PatientSMO_Patient FOREIGN KEY(ref_idPatient) REFERENCES dbo.t_Patient(id)
)
go
