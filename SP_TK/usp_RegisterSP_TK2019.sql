...
select @idFileBack=idFileBack, @idFile=rf_idFiles FROM dbo.vw_getFileBack WHERE ReportYear=2019 AND CodeM='106002' AND NumberRegister=13 AND PropertyNumberRegister=2
