...
FROM	OPENROWSET(BULK 'c:\Test\HRM371001T34_1304001.XML',SINGLE_BLOB) HRM (ZL_LIST)

SELECT	@p2=LRM.PERS_LIST				
FROM	OPENROWSET(BULK 'c:\Test\LRM371001T34_1304001.xml',SINGLE_BLOB) LRM (PERS_LIST)

DECLARE @insertTable AS table(rf_idCase bigint)

DECLARE @doc xml,
		@patient xml,
		@file varbinary(max),
		@countSluch int
SELECT @doc=@p1,@patient=@p2,@file=0x504B0304140000000800B852943F7D81517C,@countSluch=3000
...
OUTPUT INSERTED.rf_idCase INTO @insertTable
