...
(
	DR ASC,
	IM
)INCLUDE(FAM,OT,PID) WITH ( ONLINE = ON, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) 
GO
-----------------------------------------------------------4----------------------------------------------------
...
INCLUDE ( DOCN,PID) WITH ( ONLINE = ON, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) 
GO
------------------------------------------------------------5---------------------------------------------------
...
OT,
DR,
FAM,PID) WITH ( ONLINE = ON, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) 
GO
-------------------------------------------------------------6--------------------------------------------------
...
INCLUDE ( DR,PID) WITH ( ONLINE = ON, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) 
GO
--------------------------------------------------------------7-------------------------------------------------
...
INCLUDE(FAM,OT,IM,DR) WITH ( ONLINE = ON, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) 
GO
-----------------------------------------------------------------10----------------------------------------------
