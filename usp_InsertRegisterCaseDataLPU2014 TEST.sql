use RegisterCases
go
if OBJECT_ID('usp_InsertRegisterCaseDataLPU2014',N'P') is not null
drop proc usp_InsertRegisterCaseDataLPU2014
go
create proc usp_InsertRegisterCaseDataLPU2014
			@doc xml,
			@patient xml,
			@file varbinary(max),
			@countSluch int
...
insert t_Case(rf_idRecordCase, idRecordCase, GUID_Case, rf_idV006, rf_idV008,
			  ...
			  IsSpecialCase, rf_idV010, AmountPayment, Comments,Age,[Emergency])
