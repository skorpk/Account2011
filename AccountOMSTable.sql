...
(
	rf_idFiles int not null CONSTRAINT FK_RegistersAccounts_Files FOREIGN KEY(rf_idFiles) REFERENCES dbo.t_File(id),
...
(
	id int identity(1,1) not null,
	rf_idRegistersAccounts int not null CONSTRAINT FK_RecordCasePatient_RegistersAccounts FOREIGN KEY(rf_idRegistersAccounts) REFERENCES dbo.t_RegistersAccounts(id),
...
(
	...
	CONSTRAINT FK_PatientSMO_Patient FOREIGN KEY(rf_idRecordCasePatient) REFERENCES dbo.t_RecordCasePatient(id)
) ON [AccountOMSInsurer]
go
----------------------------------------------------------------------------------------------------------------
...
(
	...
	CONSTRAINT FK_Cases_RecordCasePatient FOREIGN KEY(rf_idRecordCasePatient) REFERENCES dbo.t_RecordCasePatient(id)
) ON [AccountOMSCase]
go
----------------------------------------------------------------------------------------------------------------
