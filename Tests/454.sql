...
select @idFile=id from vw_getIdFileNumber where CodeM='103001' and NumberRegister=161 and ReportYear=2020
...
SELECT DISTINCT c.id,454, ou.rf_idN013,c.GUID_Case,c.idRecordCase
